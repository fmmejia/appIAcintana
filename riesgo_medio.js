/* ==========================================================================
   LISTADO DE ESTUDIANTES EN RIESGO MEDIO - LOGICA DE NEGOCIO (riesgo_medio.js)
   ========================================================================== */

// Configuración Global y Variables de Estado
const state = {
  allStudents: [],       // Todos los estudiantes leídos de localStorage
  students: [],          // Estudiantes que están en Riesgo Medio
...
function loadPersistedData() {
  ...
  if (savedStudents) {
    ...
    // Filtrar únicamente los estudiantes en riesgo medio (Alerta CUM o promedio entre 6.0 y 6.9, aprobando todas)
    state.students = state.allStudents.filter(student => student.riskLevel === "medium");
    ...
    // Cargar filtros dinámicos basados en la población de riesgo medio
...
// Cargar Dropdowns de Filtros Dinámicamente con valores disponibles en el listado de Riesgo Medio (Excel-like dependent dropdowns)
...
function filterAndRenderStudents() {
  ...
  // Filtrar el listado que ya contiene exclusivamente estudiantes de Riesgo Medio
  ...
  if (labelEl) {
    ...
    if (count === 1) {
      ...
      labelEl.textContent = `${count} estudiantes encontrados`;
    }
  }
...
function renderStudentsTable() {
  ...
  paginatedStudents.forEach(student => {
    ...
    // Todos en esta lista son riesgo medio
